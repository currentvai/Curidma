# Check the instructions here on how to use it https://github.com/currentvai/Curidma

# Define multiple URLs (in order)
$urls = @(
    "https://raw.githubusercontent.com/currentvai/Curidma/main/IDM_Activator.cmd",
    "https://github.com/currentvai/Curidma/releases/download/latest/Curidma-main.zip",
    "https://codeload.github.com/currentvai/Curidma/zip/refs/heads/main"
)
